function createNecroptosisGasterBlaster(startX, startY, endX, endY, facePlayer=false, _depth=depth-3, rotation=0, endrotation=0, firelen=60, xscale=1, yscale=1) {
	var blaster = instance_create_depth(startX, startY, _depth, spgasterblaster);
